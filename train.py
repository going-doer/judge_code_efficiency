...
'''.format(instruction.strip()).lstrip()
    ...
    while len(encoded_prompt['input_ids']) > 2040:
...
class DataArguments:
    ...
    data_eval_path: str = field(default=None, metadata={"help": "Path to the validation data."})
...
def train():
    ...
    raw_eval_datasets = load_dataset(
        'json',
        data_files=data_args.data_eval_path,
        split="train",
    )
